...
export function ResetPasswordPage() {
  ...
  if (!token) {
    return (
      <div className="grid min-h-screen place-items-center px-4" style={{ background: "var(--bg-primary)", color: "var(--text-primary)" }}>
        <div className="w-full max-w-md rounded-2xl border p-8 text-center" style={{ background: "var(--bg-secondary)", borderColor: "var(--border-primary)" }}>
          ...
          <Link to="/" className="mt-4 inline-block rounded-lg bg-white px-5 py-2 text-sm font-medium text-black transition-colors hover:bg-zinc-200">
            На главную
          </Link>
        </div>
      </div>
